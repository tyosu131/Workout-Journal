...
COMPLETE; both providers are ACTIVE / disabled=false. Latest CD-C2D-R4 run
`35318084987` failed at A with `OIDC_ENDPOINT_VALIDATION_FAILED / P1`.
The specific endpoint condition and root cause are NOT PROVEN. B was not run,
C skipped. WIF proof and full automatic CD proof
