...
COMPLETE; both providers are ACTIVE / disabled=false. CD-C2D run `35229757740`
failed at A; B was not run, C skipped. WIF proof and full automatic CD proof remain
Open. See the [R1 diagnosis](./cd-c1-candidate-delivery.md#cd-c2d-failed-proof-and-cd-c2d-r1-diagnosis).
