...
| 3. Infrastructure as Code / Identity | Open | Existing production resources are recorded operationally; no Terraform foundation is present | Complete P1 ownership decision, implement approved Terraform scope, and verify reproducibility without secret values in state | P1 + IaC phase |
