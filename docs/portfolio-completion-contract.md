...
`candidate_e2e`, Secret Manager version 1 ENABLED. The E2E provider remains
disabled in runtime. CD-C2C proposes activation and isolated auth proof; reviewed
apply, positive/negative E2E WIF proof and full automatic CD proof remain Open.
