...
C3M improves only API failure provenance using fixed kind/stage enums and offline
tests. C3M runtime verification remains unperformed; no completion status closes.
