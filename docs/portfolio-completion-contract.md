...
[CD-C1 repository desired state](./cd-c1-candidate-delivery.md) adds dedicated E2E
identity/credential separation and a manually gated delivery implementation, but
does not close runtime gaps in this matrix. New identity apply/activation,
dedicated-key creation, E2E WIF proof and full automatic CD proof remain Open.
