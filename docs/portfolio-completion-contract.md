...
COMPLETE; both providers are ACTIVE / disabled=false. Latest CD-C2D-R6 run
`35323990499` failed at A with `OIDC_ENDPOINT_PATH_FAILED / P1`.
The undocumented fixed path suffix rejection is PROVEN; R7 removes that source
restriction and retains origin/security checks. B was not run, C skipped.
WIF proof and full automatic CD proof remain Open. See
