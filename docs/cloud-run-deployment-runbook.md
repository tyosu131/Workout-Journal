...
CD-C2D `wif-proof` run `35229757740` failed at A; B/C remain NOT PROVEN and
WIF proof remains OPEN. This auth-only mode cannot run Build, candidates, E2E
secret access or promotion; [R1 diagnosis](./cd-c1-candidate-delivery.md#cd-c2d-failed-proof-and-cd-c2d-r1-diagnosis)
